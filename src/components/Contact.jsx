...
import { RiGithubFill, RiLinkedinBoxFill, RiTwitterXFill } from "@remixicon/react"; // Social media icons
        ...
        <section className="py-16" id="contact" ref={contactRef}>
            ...
            <div className="px-4 text-center">
                ...
                <div className="contact-icon mt-8 flex justify-center space-x-6">
                    ...
                    <a
                        href="https://www.linkedin.com/in/david01example"
                        target="_blank"
                    ...
                    <a
                        href="https://github.com/david01example"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="contact-icon"
                    ...
                    {/* TwitterX icon with animation class and accessibility */}
                    <a
                        href="https://x.com/david01example"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="contact-icon"
